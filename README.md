...
defaults to llama3.1:8b which actually fits in 16gb. swap with `--model` or `OLLAMA_MODEL`.

(tried qwen3:30b to upgrade. 19gb model + 16gb ram = computer basically froze. lesson learned.)
